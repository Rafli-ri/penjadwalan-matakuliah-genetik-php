<div class="content">
   ...
   <div class="container-fluid">
      ...
      <div class="row-fluid">
         <a href="<?php echo base_url() . 'web/hari_add'; ?>"> <button class="btn btn-primary pull-right"><i class=" mdi mdi-plus"></i> Tambah Data</button></a>
         <!--
                  ...
                  <tbody>
                     ...
                     foreach ($rs_hari->result() as $hari) { ?>
                        <tr>
                           ...
                           <td>
                              <a href="<?php echo base_url() . 'web/hari_edit/' . $hari->kode; ?>" class="btn btn-primary"><i class=" mdi mdi-pencil"></i></a>
                              <a href="<?php echo base_url() . 'web/hari_delete/' . $hari->kode; ?>" class="btn btn-danger text-white" onClick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="mdi mdi-delete-forever text-white"></i></a>
                           </td>
                        </tr>
                     <?php $i++;
                     } ?>
