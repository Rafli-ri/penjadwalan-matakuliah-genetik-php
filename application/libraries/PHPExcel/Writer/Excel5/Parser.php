...
function _match($token)
{
	switch ($token) {
		...
		default:
			...
			elseif (
				preg_match("/^" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_QUOTED . "(\:" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_UNQUOTED . ")?\!\\$?[A-Ia-i]?[A-Za-z]\\$?[0-9]+$/u", $token) and
				!preg_match("/[0-9]/", $this->_lookahead) and
			...
			// If it's an external reference ('Sheet1'!A1 or 'Sheet1:Sheet2'!A1 or 'Sheet1'!$A$1 or 'Sheet1:Sheet2'!$A$1)
			elseif (
				preg_match("/^'" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_QUOTED . "(\:" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_QUOTED . ")?'\!\\$?[A-Ia-i]?[A-Za-z]\\$?[0-9]+$/u", $token) and
				!preg_match("/[0-9]/", $this->_lookahead) and
				($this->_lookahead != ':') and ($this->_lookahead != '.')
			) {
				return $token;
			...
			elseif (
				preg_match("/^" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_UNQUOTED . "(\:" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_UNQUOTED . ")?\!\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+:\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+$/u", $token) and
				!preg_match("/[0-9]/", $this->_lookahead)
			) {
				return $token;
			}
			// If it's an external range like 'Sheet1'!A1:B2 or 'Sheet1:Sheet2'!A1:B2 or 'Sheet1'!$A$1:$B$2 or 'Sheet1:Sheet2'!$A$1:$B$2
			elseif (
				preg_match("/^'" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_QUOTED . "(\:" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_QUOTED . ")?'\!\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+:\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+$/u", $token) and
				!preg_match("/[0-9]/", $this->_lookahead)
			) {
				return $token;
			}
...
function _fact()
{
	...
	// If it's an external reference (Sheet1!A1 or Sheet1:Sheet2!A1 or Sheet1!$A$1 or Sheet1:Sheet2!$A$1)
	elseif (preg_match("/^" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_UNQUOTED . "(\:" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_UNQUOTED . ")?\!\\$?[A-Ia-i]?[A-Za-z]\\$?[0-9]+$/u", $this->_current_token)) {
		$result = $this->_createTree($this->_current_token, '', '');
		$this->_advance();
		return $result;
	}
	// If it's an external reference ('Sheet1'!A1 or 'Sheet1:Sheet2'!A1 or 'Sheet1'!$A$1 or 'Sheet1:Sheet2'!$A$1)
	elseif (preg_match("/^'" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_QUOTED . "(\:" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_QUOTED . ")?'\!\\$?[A-Ia-i]?[A-Za-z]\\$?[0-9]+$/u", $this->_current_token)) {
		$result = $this->_createTree($this->_current_token, '', '');
		$this->_advance();
		return $result;
	}
	...
	elseif (preg_match("/^" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_UNQUOTED . "(\:" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_UNQUOTED . ")?\!\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+:\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+$/u", $this->_current_token)) {
		// must be an error?
	...
	elseif (preg_match("/^'" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_QUOTED . "(\:" . PHPExcel_Writer_Excel5_Parser::REGEX_SHEET_TITLE_QUOTED . ")?'\!\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+:\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+$/u", $this->_current_token)) {
		// must be an error?
		//$result = $this->_current_token;
		$result = $this->_createTree($this->_current_token, '', '');
		$this->_advance();
