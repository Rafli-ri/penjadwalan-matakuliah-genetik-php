<div class="content">
   ...
   <div class="container-fluid">
      ...
      <div class="row-fluid">
         <a href="<?php echo base_url() . 'web/jam_add'; ?>"> <button class="btn btn-primary pull-right"><i class="mdi mdi-plus"></i> Tambah Data</button></a>
         <!--
                  ...
                  <tbody>
                     ...
                     foreach ($rs_jam->result() as $jam) { ?>
                        <tr>
                           ...
                           <td>
                              <a href="<?php echo base_url() . 'web/jam_edit/' . $jam->kode; ?>" class="btn btn-primary text-white"><i class="mdi mdi-pencil text-white"></i></a>
                              <a href="<?php echo base_url() . 'web/jam_delete/' . $jam->kode; ?>" class="btn btn-danger text-white" onClick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="mdi mdi-delete-forever text-white"></i></a>
                           </td>
                        </tr>
                     <?php $i++;
                     } ?>
