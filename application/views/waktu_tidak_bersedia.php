      ...
      <div class="row-fluid">
         <form class="form" method="POST">
            <div class="form-group">
               <label class="col-sm-8">Dosen</label>
               <div class="col-sm-5">
                  <select id="kode_dosen" name="kode_dosen" class="form-select shadow-none form-control-line" onchange="change_dosen_tidak_bersedia()">
